...
chunk5WRQNO3V_cjs.init_logo_template();
function renderAdminLayout(data) {
  const {
    renderAdminLayoutCatalyst: renderAdminLayoutCatalyst2
  } = (chunk5WRQNO3V_cjs.init_admin_layout_catalyst_template(), chunkIGJUBJBW_cjs.__toCommonJS(chunk5WRQNO3V_cjs.admin_layout_catalyst_template_exports));
      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          <div class="flex items-center space-x-4">
            ${chunk5WRQNO3V_cjs.renderLogo({ size: "md", showText: true, variant: "white" })}
          </div>
...
//# sourceMappingURL=chunk-PHCKAYJY.cjs.map
//# sourceMappingURL=chunk-PHCKAYJY.cjs.map