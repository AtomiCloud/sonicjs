...
var PluginManager = class {
  ...
  async initialize(context) {
    ...
    await this.hooks.execute(chunkQTFKZBLC_cjs.HOOKS.APP_INIT, {
      pluginManager: this,
      context
    });
  ...
  async install(plugin, config) {
    ...
    try {
      ...
      await this.hooks.execute(chunkQTFKZBLC_cjs.HOOKS.PLUGIN_INSTALL, {
        plugin: plugin.name,
        version: plugin.version,
  ...
  async uninstall(name) {
    ...
    try {
      ...
      await this.hooks.execute(chunkQTFKZBLC_cjs.HOOKS.PLUGIN_UNINSTALL, {
        plugin: name,
        context: pluginContext
      });
  ...
  async shutdown() {
    ...
    await this.hooks.execute(chunkQTFKZBLC_cjs.HOOKS.APP_SHUTDOWN, {
      pluginManager: this
    });
...
async function verifyTurnstile(c, next) {
  ...
  const turnstileService = new chunkEGA3YCM5_cjs.TurnstileService(db);
...
new chunkEGA3YCM5_cjs.PluginBuilder({
  name: chunkEGA3YCM5_cjs.manifest_default.name,
  version: chunkEGA3YCM5_cjs.manifest_default.version,
  description: chunkEGA3YCM5_cjs.manifest_default.description,
  author: { name: chunkEGA3YCM5_cjs.manifest_default.author }
}).metadata({
  description: chunkEGA3YCM5_cjs.manifest_default.description,
  author: { name: chunkEGA3YCM5_cjs.manifest_default.author }
}).addService("turnstile", chunkEGA3YCM5_cjs.TurnstileService).addSingleMiddleware("verifyTurnstile", verifyTurnstile, {
...
//# sourceMappingURL=chunk-HLTGZH3M.cjs.map
//# sourceMappingURL=chunk-HLTGZH3M.cjs.map