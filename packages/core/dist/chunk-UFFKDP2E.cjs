...
chunkKF4GHKB7_cjs.init_logo_template();
function renderAdminLayout(data) {
  const {
    renderAdminLayoutCatalyst: renderAdminLayoutCatalyst2
  } = (chunkKF4GHKB7_cjs.init_admin_layout_catalyst_template(), chunkIGJUBJBW_cjs.__toCommonJS(chunkKF4GHKB7_cjs.admin_layout_catalyst_template_exports));
      ...
      <div class="px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
          <div class="flex items-center space-x-4">
            ${chunkKF4GHKB7_cjs.renderLogo({ size: "md", showText: true, variant: "white" })}
          </div>
...
//# sourceMappingURL=chunk-UFFKDP2E.cjs.map
//# sourceMappingURL=chunk-UFFKDP2E.cjs.map