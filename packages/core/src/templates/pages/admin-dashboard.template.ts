  ...
  const pageContent = `
    <div class="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p class="mt-2 text-sm/6 text-zinc-500 dark:text-zinc-400">Welcome to your ForgeFoxy admin dashboard</p>
      </div>
      <div class="mt-4 sm:mt-0 flex items-center gap-x-3">
        <a href="https://forgefoxy.com" target="_blank" class="inline-flex items-center justify-center gap-x-1.5 rounded-lg bg-lime-600 dark:bg-lime-700 px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-lime-700 dark:hover:bg-lime-600 transition-colors shadow-sm">
